...
import { AccountSelector, Members, Organizations, Products, Shipments, TopNavMenu, Tracking, Orderbook, WyvernExchange } from './components';
...
const Dashboard = (props) => {
  ...
  const panes = [
    ...
    { menuItem: 'Orderbook', render: () => <Orderbook accountPair={accountPair} /> },
    { menuItem: 'WyvernExchange', render: () => <WyvernExchange accountPair={accountPair} /> }
  ];
